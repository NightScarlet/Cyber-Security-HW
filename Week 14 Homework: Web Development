...
HTTP requests occur in a client/server based architect.

What are the different parts of an HTTP request?
There are three diffferent parts. The request line, header, and body

Which part of an HTTP request is optional?
The body.

What are the three parts of an HTTP response?
There are three different parts as well. The status line, header, and body.

Which number class of status codes represents errors?
300-500 with 300's being redirections, 400's being client errors, and 500's being server errors.
...
The body will contain the data being sent to the server.

In which part of an HTTP response does the browser receive the web code to generate and style a web page?
The HTTO sends a GET request for the wabe page which is then sent back to the client in a TCP/IP.
...
It allows you to take or add data to a server from your command line.
